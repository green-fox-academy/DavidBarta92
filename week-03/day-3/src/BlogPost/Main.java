...
public class Main {
    public static void main(String[] args) {
        BlogPost fist = new BlogPost("John Doe", "Lorem Ipsum", "Lorem ipsum dolor sit amet.", "2000.05.04.");
        BlogPost second = new BlogPost("Tim Urban", "ait but why", "A popular long-form, stick-figure-illustrated blog about almost everything.", "2010.10.10.");
