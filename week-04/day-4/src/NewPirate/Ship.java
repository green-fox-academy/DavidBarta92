...
public class Ship {
    ...
    public boolean battle(Ship otherShip){
        ...
        while (i < this.crew.size() && i < otherShip.crew.size()){
            ...
            if (this.crew.get(i).getState().equals("alive")) {
                this.score++;
                if (anotherCup == 1){
            ...
            else if (otherShip.crew.get(i).getState().equals("alive")){
                if (anotherCup == 1){
        ...
        if (this.crew.get(0).getState().equals("alive") && this.crew.get(0).getDrunkStatus()) {
            this.score++;
        }
        else if (otherShip.crew.get(0).getState().equals("alive") && otherShip.crew.get(0).getDrunkStatus()){
            otherShip.score++;
        }
